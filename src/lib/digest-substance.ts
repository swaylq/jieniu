...
const MARKET_LEVEL_NOISE =
  /龙虎榜|换手率|营业部|大宗交易|盘中异动|异动拉升|直线拉升|直线涨停|快速跳水|封板|涨停板|涨停分析|涨停复盘|\d+cm(涨停|跌停)|停复牌汇总|筹码变动|股东户数|资金流向日报|异动情报|竞价|盘前必读|早知道|午间收评|收评|盘中播报|整点回顾|开盘播报|公告精选|重点关注财经事件|今日要闻|早报|见闻早餐|早餐\s*\||晨报|复盘\d|机会前瞻/;
