...
export const ROUNDUP_TITLE =
  /收评|午评|早评|复盘|涨停潮|跌停潮|涨停榜|跌停榜|\d+只.{0,6}股|附股[)）]|大宗交易|龙虎榜|资金流[向入出]|北向资金|主力(资金|净[流买])|多只|多家个股|密集(发布|亮相|预告|披露|现身)|集体(大涨|大跌|调整|异动|走强|走弱)|排行榜|涨幅榜|跌幅榜|(基金|公募).{0,4}(二季报|三季报|一季报)|基金经理|翻倍基|盘前(情报|必读|播报)|十大券商|券商策略|研报.{0,8}一览|盈利预测一览|(下调|上调)\d+家|大盘|沪指|深指|创业板指|科创50|沪深300|三大指数|恒生(指数|科技)|中概股/;
